...
contract StandardPaymaster is IPaymaster {
        ...
        returns (bytes4 magic, bytes memory /*context*/)
    {
        ...
        // The standard general flow selector is 0x8c5a3445
        // This is keccak256("general(bytes)")[0:4]
        bytes4 paymasterInputSelector = bytes4(_transaction.paymasterInput[0:4]);
        
        require(
            paymasterInputSelector == 0x8c5a3445,
